              ...
              <Row>
                ...
                <Col md="6">
                  <div className="about_detail">
                    <h3>About us</h3>
                    <p>
                      {codeA[0].title} isn’t just an app’s catalog. Our team made a great research and handpicked the best Android and iOS apps so that you
                      could enjoy your experience with any of them. Here you will only find the titles that are worth your attention.
                    </p>
                    <p>
