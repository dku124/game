...
const GameDetail = () => {
  ...
  const cmtDisplay = comment.slice(visitedPage, visitedPage + commentPerPage);
            ...
            <Col lg="8">
              <div className="game_content">
                ...
                <section className="game_detail">
                  <p className="game_txt">{content01}</p>
                  <AdsBlock />
                  <img src={img02} alt="" />
                  <p className="game_txt">{content02}</p>
                  <AdsBlock />
                  <img src={img03} alt="" />
                  <p className="game_txt">{content03}</p>
                  <AdsBlock />
                  <img src={img04} alt="" />
                  <p className="game_txt">{content04}</p>
                  <AdsBlock />
                  <p className="game_txt">{content05}</p>
                </section>
                ...
                <section className="section_comment">
                  <div className="comment_block">
                    ...
                    <div className="comment_content">
                      <h3 className="section_title">{comment.length} Comment</h3>
